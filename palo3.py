...
POLE_METADATA = {
    ...
    "sensors": [
        {"sensor_id": "temp_03", "sensor_type": "thermometer", "unit": "Celsius"},
        {"sensor_id": "hum_03", "sensor_type": "hygrometer", "unit": "%"},
        {"sensor_id": "tilt_03", "sensor_type": "accelerometer", "unit": "degrees", "threshold": 15}
    ]
}
...
def main():
    ...
    client.publish(TOPIC, json.dumps(POLE_METADATA))
    time.sleep(2)
    ...
    try:
        while True:
            ...
            # Solo per loggare a video cosa stiamo mandando
            alert_msg = " [!!!]" if readings['tilt'] > 15 else ""
            print(f"-> {POLE_ID}: Tilt {readings['tilt']}°{alert_msg}")
